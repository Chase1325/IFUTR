...
class Pozyx2GPSConverter:
    ...
    def __init__(self, yaw_alignment=0, lat_0=42.273283958,
                 long_0=-71.8083867, elevation=174):
        """
        ...
        # JSON Packet that will be sent to MavProxy
        self.data = {
        ...
        # Store GPS epoch for usage later
